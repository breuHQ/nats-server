// Copied from https://github.com/golang/time
...
func (lim *Limiter) TestLimiterr() {
	fmt.Println("Limiter initialized")
	...
	go func() {
		defer wg.Done()
		fmt.Printf("Req 1 start: %s \n", time.Now())

		if err := lim.Wait(context.Background()); err != nil {
			fmt.Println(err)
		}

		fmt.Printf("Req 1 end: %s \n", time.Now())
		// DoWork
		fmt.Println("Request 1 allowed using wait")
	}()
	wg.Wait()
